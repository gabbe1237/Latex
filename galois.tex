...
\begin{mylemma}{}{}
  Låt $f(X)$ vara ett polynom över kroppen $F$ och låt $L$ vara dess splittringskropp. Då är 
  \[K = F(\alpha_1, \alpha_2, \ldots, \alpha_n)\]
  en splittringskropp för $f(X)$ över $F$ där $\alpha$ är rötterna till $f(X)$.
\end{mylemma}
...
\begin{proof}
  ...
  och alla rötter till $g(X)$ så är $K_1$ en splittringskropp för $g(X).$ Enligt \hyperlink{6.0.2}{lemma 6.0.2} så existerar det en isomorfism 
  ...
  som ger oss att $K_2$ är en splittringskropp för $g^{\psi}(X)$. Enligt induktionsantagandet får vi att (glöm inte att skriva "splittringskroppen över..." )
\end{proof}
